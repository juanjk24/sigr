...
CREATE TABLE IF NOT EXISTS "orders" (
	...
	"type" varchar(30) DEFAULT 'para_aqui' NOT NULL,
...
CREATE TABLE IF NOT EXISTS "payments" (
	...
	"method" varchar(30) DEFAULT 'efectivo' NOT NULL,
...
END $$;
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "dishes_category_idx" ON "dishes" USING btree ("category_id");--> statement-breakpoint
